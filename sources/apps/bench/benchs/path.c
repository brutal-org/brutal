...
BENCH(brutal_logo_fill)
{
    ...
    gfx_fill_svg(gfx, str$(logo), GFX_FILL_EVENODD);
...
BENCH(brutal_logo_rotated)
{
    ...
    gfx_push(gfx);
    gfx_origin(gfx, m_vec2f(500, 300));
    gfx_trans(gfx, trans);
