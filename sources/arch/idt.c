...
void idt_initialize(void)
{
    ...
    //idt[127] = idt_entry((void *)__interrupt_vector[48], 0, IDT_GATE | IDT_USER); // syscall interrupt
    //idt[100] = idt_entry((void *)__interrupt_vector[49], 1, IDT_GATE | IDT_USER); // multi processor signal interrupt 
