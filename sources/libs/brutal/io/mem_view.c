...
static IoResult mem_view_read_impl(MemView *self, char *data, size_t offset, size_t size)
{
...
static IoResult mem_view_write_impl(MemView *self, char const *data, MAYBE_UNUSED size_t offset, size_t size)
{
